...
2. Declare the following dependency in your build.gradle file
        ...
        compile 'com.pushtechnology.gateway:gateway-framework:0.14.0'

#### Gateway framework artifacts
Get the bundled Gateway Framework jar and schema definition for configuration [here](https://download.pushtechnology.com/gateway-framework/0.14.0/gateway-framework-0.14.0-bundle.zip). This also contains an in-depth user guide about Gateway framework.

More details about the gateway framework can be found [here](https://download.pushtechnology.com/gateway-framework/0.14.0/user-guide/FrameworkUserGuide.html)